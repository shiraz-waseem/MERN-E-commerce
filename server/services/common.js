...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: "maliktraders123321@gmail.com",
...
exports.receiveemail = async function ({ to, subject, text, html }) {
  const info = await transporter.sendMail({
    from: "E-commerce Store <maliktraders@gmail.com>", // sender address
    to, // list of receivers
    subject,
...
exports.cookieExtractor = function (req) {
  ...
  // token =
  //   "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2ZTlkYzIzOTUyNzEwYzcwZDQyYTFiNCIsInJvbGUiOiJhZG1pbiIsImlhdCI6MTcyNjgzOTczNn0.md4W2kWe6-Bw6qNFbpOp2m8jgHpAxl-TIVS25PRuXYQ";
  return token;
};
         ...
         <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
           ...
           <tr>
             <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
               <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="shiraz.waseem2@gmail.com">contact us</a>.</p>
             </td>
           </tr>
           <!-- end copy -->
           <!-- start receipt table -->
...
// receive order
exports.invoiceTemplateAdmin = function (order) {
  return `<!DOCTYPE html>
 <html>
 <head>
   <meta charset="utf-8">
